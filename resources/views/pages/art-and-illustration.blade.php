...
@section('title', 'Art & Illustration')


@section('content')
<section class="inner-banner art-and-illustration">
    <div class="container-fluid">
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-5">
                <div class="inner-banner-content">
                    <h1 class="banner-title">Visuals for Effective Communication</h1>
                    <p class="body-intro">
                        In the current digital world, quality
                        visuals and lively illustrations are the
                        keys to depicting your products and services.
                        Visuals have come to hold great power in
                        effective communication, as they capture
                        people’s attention and allow you to propagate
                        your ideas.
                    </p>
                    <div class="buttons">
            ...
            <div class="col-lg-5">
                <div class="banner-slider">
                    <div class="slide-1 d-flex align-items-center justify-content-center">
                        <img src="../images/art-1.png" class="img-fluid" alt="">
                    </div>
                    <div class="slide-2 d-flex align-items-center justify-content-center">
                        <img src="../images/illustration-1.png" class="img-fluid" alt="">
                    </div>
                    <div class="slide-3 d-flex align-items-center justify-content-center">
                        <img src="../images/art-2.png" class="img-fluid" alt="">
                    </div>
                    <div class="slide-5 d-flex align-items-center justify-content-center">
                        <img src="../images/illustration-2.png" class="img-fluid" alt="">
                    </div>
                    <div class="slide-5 d-flex align-items-center justify-content-center">
                        <img src="../images/illustration-3.png" class="img-fluid" alt="">
                    </div>
                    <div class="slide-6 d-flex align-items-center justify-content-center">
                        <img src="../images/art-4.png" class="img-fluid" alt="">
                    </div>
                </div>
            </div>
        </div>
