...
@section('title', 'Packaging & Label')


@section('content')
<section class="inner-banner packaging-and-label">
  <div class="container-fluid">
      <div class="row align-items-center justify-content-center">
          <div class="col-lg-5">
              <div class="inner-banner-content">
                  <h1 class="banner-title">PACKAGING AND <br> LABEL</h1>
                  <p class="body-intro">
                      Make an exceptional impression of your brand
                      at the next product launch.Good quality of the
                      products is essential, but what tempts people
                      to try out your product in the first place is
                      on the outside.
                  </p>
                  <div class="buttons">
