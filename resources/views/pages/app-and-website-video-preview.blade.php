...
@section('title', 'App & Website Video Preview')


@section('content')
<section class="inner-banner app-and-website-video">
    <div class="container-fluid">
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-5">
                <div class="inner-banner-content">
                    <h1 class="banner-title">APP AND WEBSITE VIDEO PREVIEW</h1>
                    <p class="body-intro">
                        A step closer to enhanced online visibility Allow your
                        customers to quickly assess your app or website before
                        they use it. This results in more educated and engaged
                        users, which ultimately leads to greater retention rates.
                    </p>
                    <p class="body-intro">
                        The Dominance of Visual Communication Statistics prove
                        that web Pages with videos attract 3-4 times more monthly
                        audience than those without videos, There’s a 157%
                        increase in organic
                    </p>
                    <div class="buttons">
            ...
            <div class="col-lg-5">
                <div class="banner-slider">
                    ...
                    <div class="slide-2 d-flex align-items-center justify-content-center">
                        <img src="../images/slide-2.png" class="img-fluid" alt="">
                    </div>
                    ...
                    <div class="slide-5 d-flex align-items-center justify-content-center">
                        <img src="../images/logo-slide-2.png" class="img-fluid" alt="">
                    </div>
                    <div class="slide-6 d-flex align-items-center justify-content-center">
                        <img src="../images/logo-slide-4.png" class="img-fluid" alt="">
                    </div>
                </div>
            </div>
        </div>
