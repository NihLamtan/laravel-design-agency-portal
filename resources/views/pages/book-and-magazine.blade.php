...
@section('title', 'Book and Magazine')
      ...
      <div class="row align-items-center justify-content-center">
          <div class="col-lg-5">
              <div class="inner-banner-content">
                  <h1 class="banner-title">Your Work of Art Deserves A Great Design</h1>
                  <p class="body-intro">
                      Make your books and magazines sell better using creative designs that attract your target audience.
                  </p>
                  <div class="buttons">
          ...
          <div class="col-lg-5">
              <div class="banner-slider">
                  ...
                  <div class="slide-2 d-flex align-items-center justify-content-center">
                      <img src="../images/magazine-1.png" class="img-fluid" alt="">
                  </div>
                  <div class="slide-3 d-flex align-items-center justify-content-center">
                      <img src="../images/book-2.png" class="img-fluid" alt="">
                  </div>
                  <div class="slide-5 d-flex align-items-center justify-content-center">
                      <img src="../images/magazine-2.png" class="img-fluid" alt="">
                  </div>
                  <div class="slide-6 d-flex align-items-center justify-content-center">
                      <img src="../images/book-3.png" class="img-fluid" alt="">
                  </div>
                  <div class="slide-6 d-flex align-items-center justify-content-center">
                      <img src="../images/magazine-3.png" class="img-fluid" alt="">
                  </div>
              </div>
          </div>
      </div>
