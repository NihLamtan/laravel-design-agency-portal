...
@section('title', 'Animated Videos For Kids')


@section('content')
<section class="inner-banner animated-videos">
  <div class="container-fluid">
      <div class="row align-items-center justify-content-center">
          <div class="col-lg-5">
              <div class="inner-banner-content">
                  <h1 class="banner-title">ANIMATED VIDEO FOR KIDS</h1>
                  <h6 class="mt-4 mb-4">
                      It’s no secret how fascinating pictures and videos are for kids.
                  </h6>
                  <p class="body-intro">
                      However, to truly engage their imagination, you
                      need specifications in your videos. We offer top-quality
                      animations that blend important components in your videos
                      to make them appealing. We make appropriate use of fonts,
                      colors, and images to enhance our animations.
                  </p>
                  <div class="buttons">
