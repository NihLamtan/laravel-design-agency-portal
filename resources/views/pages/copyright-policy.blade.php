...
<section class="section terms-and-policies">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h1 class="banner-title text-center">Copyright Policy</h1>
                <div class="terms-and-conditions">
                    <h4 class='content-title'>1. Condition</h4>
                    <p class="medium-text">
                    ...
                    <h4 class='content-title'>2. Condition</h4>
                    <p class="medium-text">
                    Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy
                    text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has
                    survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.
                    </p>
                    <h4 class='content-title'>3. Condition</h4>
                    <ul>
                        <li>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</li>
                        <li>Lorem Ipsum has been the industry's standard dummy.</li>
                        <li>Text ever since the 1500s, when an unknown printer took a galley.</li>
                        <li>Of type and scrambled it to make a type specimen book.</li>
                    ...
                    <h4 class='content-title'>4. Condition</h4>
                    <p class="medium-text">
                    Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy
                    text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book
                    </p>
                    <h4 class='content-title'>5. Condition</h4>
                    <p class="medium-text">
                    Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy
                    text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has
                    survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised
                    ...
                    <h4 class='content-title'>6. Condition</h4>
                    <p class="medium-text">
                    Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy
                    text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has
                    survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised
