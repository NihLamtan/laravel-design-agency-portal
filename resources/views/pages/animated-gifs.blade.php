...
@section('title', 'Animated GIFs')

@section('content')
<section class="inner-banner animated-gifs">
    <div class="container-fluid">
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-5">
                <div class="inner-banner-content">
                    <h1 class="banner-title">ANIMATED GIFS</h1>
                    <h6 class="mt-4 mb-4">
                        Turn Your Ideas Into Masterpiece Animations.
                    </h6>
                    <p class="body-intro">
                        Animated gifs offer a middle ground between
                        images and photos, and present a solid case
                        of what you’re offering. Premium quality
                        videos tailored to the unique needs of our customers.
                    </p>
                    <div class="buttons">
            ...
            <div class="col-lg-5">
                <div>
                    <img src="../images/animated-gif-1.gif" class="img-fluid" alt="">
                </div>
            </div>
        </div>
    </div>
