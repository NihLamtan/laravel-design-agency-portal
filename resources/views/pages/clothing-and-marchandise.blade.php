...
@section('title', 'Clothing & Merchandise')


@section('content')
<section class="inner-banner clothing-merchandise">
    <div class="container-fluid">
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-5">
                <div class="inner-banner-content">
                    <h1 class="banner-title">Make your brand look the best with
                         a style that is distinctively ‘YOU’</h1>
                    <p class="body-intro">
                        Turn your masterpiece ideas into reality and enhance
                         your brand identity with our custom imprinted products.
                    </p>
                    <p class="body-intro">
                        Get designs from classic pullovers to branding merchandise,
                        and everything in between. Incorporate the logo with artistic
                        brilliance in a manner that highlights it in the crowd.
                    </p>
                    <div class="buttons">
            ...
            <div class="col-lg-5">
                <div class="banner-slider">
                    <div class="slide-1 d-flex align-items-center justify-content-center">
                        <img src="../images/cloth-1.png" class="img-fluid" alt="">
                    </div>
                    <div class="slide-2 d-flex align-items-center justify-content-center">
                        <img src="../images/cloth-2.png" class="img-fluid" alt="">
                    </div>
                    <div class="slide-3 d-flex align-items-center justify-content-center">
                        <img src="../images/cloth-3.png" class="img-fluid" alt="">
                    </div>
                    <div class="slide-5 d-flex align-items-center justify-content-center">
                        <img src="../images/cloth-4.png" class="img-fluid" alt="">
                    </div>
                    <div class="slide-6 d-flex align-items-center justify-content-center">
                        <img src="../images/cloth-5.png" class="img-fluid" alt="">
                    </div>
                </div>
            </div>
        </div>
