...
@section('title', '3D Product Animation')

@section('content')
<section class="inner-banner product-animation">
  <div class="container-fluid">
      <div class="row align-items-center justify-content-center">
          <div class="col-lg-5">
              <div class="inner-banner-content">
                  <h1 class="banner-title">3D PRODUCT ANIMATION</h1>
                  <!-- <p class="body-intro">
                      Showcase your products in the best light:From
                      simple product demonstrations to complex
                      conceptual videos, bring your biggest ideas
                      to life with high-quality animations that
                      leave your audience awestruck.
                  </p> -->
                  <p class="body-intro">
                      A Digital Experience for your Customers: Statistics
                      prove that customers who view product videos are 85%
                      more likely to buy the product than those who don’t.
                      In recent years, product animations have gained
                      popularity and are being widely used by businesses.
                  </p>
                  <div class="buttons">
          ...
          <div class="col-lg-5">
              <div>
                  <div class="slide-1 d-flex align-items-center justify-content-center">
                      <img src="../images/product-animation-3.gif" class="img-fluid" alt="">
                  </div>
              </div>
          </div>
      </div>
