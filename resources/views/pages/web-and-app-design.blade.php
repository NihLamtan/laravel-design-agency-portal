...
@section('title', 'Web & App Design')


@section('content')
<section class="inner-banner web-and-app">
  <div class="container-fluid">
      <div class="row align-items-center justify-content-center">
          <div class="col-lg-5">
              <div class="inner-banner-content">
                  <h1 class="banner-title">Create an experience, not just a website</h1>
                  <h6 class="mt-4 mb-4">Great design is the crux of every business website</h6>
                  <p class="body-intro">
                      Unlimited design assets perfect for building
                      your brand and product offering. Design
                      customized product designs, logos, apparel,
          ...
          <div class="col-lg-5">
              <div class="banner-slider">
                  <div class="slide-1 d-flex align-items-center justify-content-center">
                      <img src="../images/business-img-1.png" class="img-fluid" alt="">
                  </div>
                  <div class="slide-2 d-flex align-items-center justify-content-center">
                      <img src="../images/business-img-2.png" class="img-fluid" alt="">
                  </div>
                  <div class="slide-3 d-flex align-items-center justify-content-center">
                      <img src="../images/business-img-3.png" class="img-fluid" alt="">
                  </div>
                  <div class="slide-4 d-flex align-items-center justify-content-center">
                      <img src="../images/business-img-4.png" class="img-fluid" alt="">
                  </div>
              </div>
          </div>
      </div>
