...
@section('title', '3D Character Modeling & Animation')


@section('content')
<section class="inner-banner character-animation">
    <div class="container-fluid">
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-5">
                <div class="inner-banner-content">
                    <h1 class="banner-title">3D CHARACTER MODELING AND ANIMATION</h1>
                    <p class="body-intro">
                        Digital Storytelling:Contrary to popular opinion, video
                        making and animations is an art. You must create an
                        exciting story that actively engages the audience
                        and makes them want to watch till the end. We make
                        animations that stand out from the clutter and make
                        an impact.
                    </p>
                    <div class="buttons">
            ...
            <div class="col-lg-5">
                <div class="banner-slider">
                    <div class="slide-1 d-flex align-items-center justify-content-center">
                        <img src="../images/3d-character-7.png" class="img-fluid" alt="">
                    </div>
                    <div class="slide-2 d-flex align-items-center justify-content-center">
                        <img src="../images/3d-character-8.png" class="img-fluid" alt="">
                    </div>
                    <div class="slide-3 d-flex align-items-center justify-content-center">
                        <img src="../images/3d-character-9.png" class="img-fluid" alt="">
                    </div>
                    <div class="slide-5 d-flex align-items-center justify-content-center">
                        <img src="../images/3d-character-10.png" class="img-fluid" alt="">
                    </div>
                    <div class="slide-5 d-flex align-items-center justify-content-center">
                        <img src="../images/3d-character-11.png" class="img-fluid" alt="">
                    </div>
                    <div class="slide-5 d-flex align-items-center justify-content-center">
                        <img src="../images/3d-character-12.png" class="img-fluid" alt="">
                    </div>
                </div>
            </div>
        </div>
