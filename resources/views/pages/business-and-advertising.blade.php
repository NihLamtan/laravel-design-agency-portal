...
@section('content')
<section class="inner-banner business-and-advertise">
  <div class="container-fluid">
      <div class="row align-items-center justify-content-center">
          <div class="col-lg-5">
              <div class="inner-banner-content">
                  <h1 class="banner-title">BUSINESS OR ADVERTISING</h1>
                  <p class="body-intro">
                      When it comes to business advertising,
                      it’s important to design strategies
                      that result in sales.
                  </p>
                  <p class="body-intro">
                      You don’t need people to see your brand
                      everywhere and ignore it. What you do need
                      is that whenever someone comes across your brand, they buy.
                  </p>
                  <div class="buttons">
