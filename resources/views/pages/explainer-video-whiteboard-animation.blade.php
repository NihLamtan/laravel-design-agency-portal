...
@section('title', 'Explainer Video & Whiteboard Animatcion')


@section('content')
<section class="inner-banner explainer-video">
    <div class="container-fluid">
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-5">
                <div class="inner-banner-content">
                    <h1 class="banner-title">EXPLAINER VIDEO <br> AND WHITEBOARD ANIMATION</h1>
                    <p class="body-intro">
                        Communicate your thoughts and give your
                        clients one more reason to believe in you.
                    </p>
                    <p class="body-intro">
                        One of the most compelling ways to explain
                        your business ideas is through visual depiction.
                        Our explanation and whiteboard animation videos
                        allow you to tell stories that double investments.
                    </p>
                    <div class="buttons">
            ...
            <div class="col-lg-5">
                <div>
                    <img src="../images/whiteboard-animation.gif" class="img-fluid" alt="">
                </div>
