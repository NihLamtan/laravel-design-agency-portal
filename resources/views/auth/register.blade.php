    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <x-jet-input class="block mt-1 w-full" type="text" name="phone" :value="old('number')" />
            </div>

            {{-- <div class="mt-4">
                <x-jet-label value="{{ __('Country') }}" />
                <x-select-country class="block mt-1 w-full" name="country" :value="old('country')" required />
            </div> --}}
